...
mix
    ...
    .js('resources/assets/js/discount/discount/discount.js', 'public/js/discount/discount')
    .js('resources/assets/js/news/news/news.js', 'public/js/news/news')
    ...
    .js('resources/assets/js/discount/discount/addDiscount.js', 'public/js/discount/discount')
    .js('resources/assets/js/news/news/addNews.js', 'public/js/news/news')
